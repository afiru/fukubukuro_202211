...
<head>
    <?php
    $title          = "happybag2024｜GEOGRAPHY";
    $keyword        = "GEOGRAPHY,カジュアルウェア,ジーンズ,ファッション,福袋,2024";
    $description    = "2024年福袋！ご予約承り中！数量限定のためご予約はお早めに！";
    $thumbs         = "";
...
?>
    ...
    })(window, document, 'script', 'dataLayer', 'GTM-PNQF4NL');
    </script>
...
<body id="page_top" class="wapper body_back_black">
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PNQF4NL" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
